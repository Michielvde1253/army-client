package game.missions
{
   ...
   public class OpenMission extends Objective
   {
       
      
      public function OpenMission(param1:Object)
      {
         super(param1);
      }
      ...
      override public function initialize(param1:String, param2:Object) : void
      {
         ...
         {
            GameState.mInstance.mHUD.setMissionButtonHighlight();
      ...
      {
         GameState.mInstance.mHUD.removeShopHighlight();
