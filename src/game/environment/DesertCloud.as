package game.environment
{
   ...
   public class DesertCloud extends RandomEffect
   {
       
      
      private var SPEED:Number = 0.6;
      
      private var DURATION_MS:int = 50000;
      
      private var FADE_MS:int = 3000;
      
      private var mAge:int = 0;
      
      public function DesertCloud()
      {
         ...
         if(FeatureTuner.USE_CLOUD_EFFECTS)
         {
            if(mGraphicsLoaded)
            {
               _loc1_ = DCResourceManager.getInstance().getSWFClass("swf/effects_environment","cloud_animation_02");
               _loc2_ = new _loc1_();
