package game.gameElements
{
   ...
   public class ResourceBuildingObject extends PlayerBuildingObject
   {
       
      
      private var mGoToHireDialog:Boolean;
      
      private var mFriends:Array;
      
      private var mSpeedUpIcon:MovieClip;
      
      private var mFriendUIDs:Array;
      
      public function ResourceBuildingObject(param1:int, param2:IsometricScene, param3:MapItem, param4:Point, param5:DisplayObject = null, param6:String = null)
      {
         ...
         var _loc7_:Class = DCResourceManager.getInstance().getSWFClass(Config.SWF_INTERFACE_NAME,"icon_speed_up");
         this.mSpeedUpIcon = new _loc7_();
         this.mSpeedUpIcon.mouseEnabled = false;
         this.mSpeedUpIcon.mouseChildren = false;
      ...
      override public function updateTooltip(param1:int, param2:TooltipHealth) : void
      {
         ...
         {
            param2.setWaterAmountText("");
         }
         else
         {
            param2.setWaterAmountText("" + GameState.mInstance.mPlayerProfile.mWater);
         }
         if(!isFullHealth())
         {
