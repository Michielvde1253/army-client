package game.gui
{
   ...
   public class AskPartsDialogSmall extends AskPartsDialog
   {
       
      
      public function AskPartsDialogSmall()
      {
         var _loc2_:StylizedHeaderClip = null;
         var _loc1_:Class = DCResourceManager.getInstance().getSWFClass(Config.SWF_POPUPS_01_NAME,"popup_finish_building_small");
