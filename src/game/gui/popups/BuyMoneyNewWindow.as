package game.gui.popups
{
   ...
   public class BuyMoneyNewWindow extends PopUpWindow
   {
      ...
      public function BuyMoneyNewWindow()
      {
         var _loc1_:Class = DCResourceManager.getInstance().getSWFClass(Config.SWF_POPUPS_WARNINGS_NAME,"popup_buy_cash");
      ...
      public function Activate(param1:Function) : void
      {
         ...
         _loc2_ = new StylizedHeaderClip(mClip.getChildByName("Header") as MovieClip,GameState.getText("BUY_CASH_WARNING_HEADER"));
         _loc3_ = mClip.getChildByName("Text_Description") as TextField;
         _loc3_.text = GameState.getText("BUY_CASH_WARNING_DESC");
         this.mButtonUnlock.setText(GameState.getText("BUY_CASH_WARNING_BUTTON_TEXT"));
      }
