package game.gui.popups
{
   ...
   public class InfantryCapFullWindow extends PopUpWindow
   {
      ...
      public function InfantryCapFullWindow()
      {
         var _loc1_:Class = DCResourceManager.getInstance().getSWFClass(Config.SWF_POPUPS_WARNINGS_NAME,"popup_infantry_cap_full");
