package game.gui.popups
{
   ...
   public class ArmorCapFullWindow extends PopUpWindow
   {
      ...
      public function ArmorCapFullWindow()
      {
         var _loc1_:Class = DCResourceManager.getInstance().getSWFClass(Config.SWF_POPUPS_WARNINGS_NAME,"popup_armor_cap_full");
      ...
      public function Activate(param1:Function) : void
      {
         ...
         _loc3_.text = GameState.getText("MENU_DESC_UNIT_MECHANIZED");
      }
