package game.items
{
   ...
   public class ShopItem extends Item
   {
      ...
      {
         return this.mEarlyUnlockBought || this.hasRequiredLevel() && this.hasRequiredAllies() && this.hasRequiredMission() && this.hasRequiredItem() && this.hasRequiredBuilding() && !this.isAlreadyAdded();
      }
      ...
      {
         var _loc1_:String = "";
         if(this.isAlreadyAdded() || !this.canBeBuiltOnThisMap())
         {
            _loc1_ += GameState.getText("SHOP_BUILDING_ALREADY_ADDED");
         }
